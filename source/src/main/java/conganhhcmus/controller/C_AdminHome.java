...
public class C_AdminHome implements Initializable {
...
//                cardView();
    ...
    public Pane list(Conference conference) {
        ...
        detail.setOnMouseClicked(event -> {
            try {
                changeDetail("/view/admin_edit_conference.fxml", conference);
            } catch (IOException e) {
                e.printStackTrace();
            }
        });
    ...
    public void create() {
        ...
        try {
            changeCreate("/view/create_conference.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public void changeCreate(String path) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource(path));
        Parent tmp = loader.load();
        Scene scene = new Scene(tmp);

        C_AdminConference temp = loader.getController();
        temp.loadData(user);
    ...
    public void changeDetail(String path, Conference data) throws IOException {
        ...
        C_AdminEditConference temp = loader.getController();
